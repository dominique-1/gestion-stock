            ...
            <div class="bg-gradient-to-br from-green-500/20 to-emerald-500/20 rounded-3xl p-6 border border-green-500/30">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-black text-white">{{ $stats['total_in'] ?? 0 }}</p>
                    </div>
            ...
            <div class="bg-gradient-to-br from-red-500/20 to-pink-500/20 rounded-3xl p-6 border border-red-500/30">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-black text-white">{{ $stats['total_out'] ?? 0 }}</p>
                    </div>
            ...
            <div class="bg-gradient-to-br from-blue-500/20 to-indigo-500/20 rounded-3xl p-6 border border-blue-500/30">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-black text-white">{{ ($stats['total_in'] ?? 0) - ($stats['total_out'] ?? 0) }}</p>
                    </div>
                ...
                <table class="w-full">
                    <thead>
                        <tr class="border-b border-white/20">
                            ...
                            <th class="text-left p-6 text-white/80 font-bold uppercase tracking-wider text-sm">Utilisateur</th>
                        ...
                        <tr class="border-b border-white/10 hover:bg-white/5 transition-all duration-300">
                            ...
                            <td class="p-6">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <span class="text-white">{{ $movement->user->name ?? 'Système' }}</span>
                                </div>
                            </td>
                            <td class="p-6">
