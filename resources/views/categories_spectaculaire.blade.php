                ...
                <div class="bg-white/10 backdrop-blur-xl rounded-3xl p-8 border border-white/20">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-gradient-to-r from-emerald-500/20 to-teal-500/20 rounded-2xl p-6">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-3xl font-black text-white">{{ $stats['total_categories'] ?? 0 }}</p>
                                </div>
                        ...
                        <div class="bg-gradient-to-r from-blue-500/20 to-cyan-500/20 rounded-2xl p-6">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-3xl font-black text-white">{{ $stats['categories_with_products'] ?? 0 }}</p>
                                </div>
                        ...
                        <div class="bg-white/5 rounded-2xl p-6">
                            <p class="text-gray-400 text-sm font-bold uppercase tracking-wider mb-4">Distribution</p>
                            <div class="space-y-3">
                                @foreach($stats['top_categories'] ?? [] as $topCategory)
                                <div class="flex items-center justify-between">
                                    <span class="text-white text-sm">{{ $topCategory->name }}</span>
                                    <div class="flex items-center space-x-2">
                                        <div class="w-24 h-2 bg-white/10 rounded-full overflow-hidden">
                                            <div class="h-full bg-gradient-to-r from-emerald-400 to-teal-400 rounded-full" style="width: {{ $topCategory->percentage }}%"></div>
                                        </div>
                                        <span class="text-emerald-400 text-sm font-bold">{{ $topCategory->percentage }}%</span>
                                    </div>
                                </div>
                                @endforeach
                            </div>
